<section>
  ...
  <div class="text-slate-500 dark:text-slate-400 space-y-8">
    <div class="space-y-4">
      <h2 class="h3 font-aspekta text-slate-800 dark:text-slate-100">
        Short Bio
      </h2>
      <p>
        ...
        tinkering with infrastructure, all things containers and Cloud Native.
      </p>
      <p>
        While there isn't a Wikipedia page about me (sorry folks!), a media bio
        is available below.
      </p>
    </div>
    <div class="space-y-4">
      <h2 class="h3 font-aspekta text-slate-800 dark:text-slate-100">Career</h2>
      <p>
        In my role as a Senior Software Engineer for Google Chrome, I am
        responsible for developing and maintaining the <a
          class="font-medium text-sky-500 hover:underline"
          href="#0">Chrome Web Browser</a
        >.
      </p>
      <p>
        ...
        Chrome is well-integrated with other <a
          class="font-medium text-sky-500 hover:underline"
          href="#0">Google</a
        > products and services.
      </p>
      <p>
        As CTO of AppForYou, <strong
          class="font-medium text-slate-800 dark:text-slate-100"
          >I am responsible for leading</strong
        > the technical teamand developing the company's technology strategy. I work
        closely with the engineering team to ensure that the products and services
        we provide are secure.
      </p>
    </div>
    <div class="space-y-8">
      <h2 class="h3 font-aspekta text-slate-800 dark:text-slate-100">
      ...
      <ul class="space-y-8">
        ...
        <li class="relative group">
          <div
            class="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-slate-200 before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8 before:group-last-of-type:hidden"
          >
            <div
              class="absolute left-0 h-14 w-14 flex items-center justify-center border border-slate-200 dark:border-slate-800 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30 bg-white dark:bg-slate-900 rounded-full"
            >
            ...
            <div class="pl-20 space-y-1">
              <div class="text-xs text-slate-500 uppercase">
                May 2020 <span class="text-slate-400 dark:text-slate-600"
                  >·</span
                > Present
              </div>
              <div
                class="font-aspekta font-[650] text-slate-800 dark:text-slate-100"
              >
        ...
        <li class="relative group">
          ...
          >
            ...
            <div class="pl-20 space-y-1">
              <div class="text-xs text-slate-500 uppercase">
                May 2017 <span class="text-slate-400 dark:text-slate-600"
                  >·</span
                > Apr 2020
              </div>
              <div
        ...
        <li class="relative group">
          ...
          >
            ...
            <div class="pl-20 space-y-1">
              <div class="text-xs text-slate-500 uppercase">
                Jan 2017 <span class="text-slate-400 dark:text-slate-600"
                  >·</span
                > Apr 2017
              </div>
              <div
        ...
        <li class="relative group">
          ...
          >
            ...
            <div class="pl-20 space-y-1">
              <div class="text-xs text-slate-500 uppercase">
                Feb 2016 <span class="text-slate-400 dark:text-slate-600"
                  >·</span
                > Dec 2016
              </div>
              <div
    ...
    <div class="space-y-4">
      ...
      <p>
        I'm excited to connect with others via <a
          class="font-medium text-sky-500 hover:underline"
          href="#0">email</a
        >
        and
        <a class="font-medium text-sky-500 hover:underline" href="#0">Twitter</a
        > to chat about projects and ideas. Currently, I'm not taking on freelance
        projects, but I am open to hearing about potential opportunities, discussing
        them with you and then potentially collaborating if it's a good fit.
      </p>
    </div>
  </div>
</section>
